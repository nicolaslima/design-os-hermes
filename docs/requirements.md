...
- **An AI coding assistant** — Design OS uses Hermes Agent skills to guide the design process. Hermes Agent is recommended, but you can invoke the Design OS commands from any AI coding tool that supports custom commands or prompts (Claude Code, Cursor, Windsurf, Codex, etc.)
