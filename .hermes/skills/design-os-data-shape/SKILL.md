---
name: design-os-data-shape
description: "Design OS: Create or update the general shape of your product's data — core entities (nouns) and how they relate."
version: 1.0.0
parent: design-os
---
...
"Before defining your data shape, you'll need to establish your product vision. Please load `/skill design-os-product-vision` first."
...
This provides a shared vocabulary for your screen designs. When you run `/skill design-os-sample-data`, it will reference these entities to ensure consistent naming across sections.

Review and let me know if you'd like to adjust anything. When you're ready, load `/skill design-os-design-tokens` to choose your color palette and typography."
